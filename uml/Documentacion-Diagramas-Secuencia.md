...
![Secuencia: comprar almuerzo](secuencia-compra-almuerzo.svg)

**Fuente:** `secuencia-compra-almuerzo.puml` · **Referencia:** UC4, `uml/actividad-compra-almuerzo.puml`.
...
![Secuencia: retiro y entrega](secuencia-retiro-entrega.svg)
...
![Secuencia: sincronización ERP](secuencia-sincronizacion-erp.svg)

**Fuente:** `secuencia-sincronizacion-erp.puml` · **Referencia:** `Hallazgos-Ingenieria-API-Generica.md` sección 3.4, `uml/objeto-integracion-erp.puml`, `uml/actividad-sincronizacion-erp.puml`.

...
: Requerimientos de producto — usabilidad
...
: Requerimientos de producto — eficiencia y rendimiento
...
: Requerimientos de producto — fiabilidad y disponibilidad
...
: Requerimientos de producto — seguridad (propiedades del producto)
...
: Requerimientos de producto — portabilidad y mantenibilidad
...
: Requerimientos organizacionales — de proceso y desarrollo
...
| **RNF-O-11** | Debe existir un **procedimiento de conciliación** entre las ventas de Aliflow y los registros del ERP de cada local, con un responsable designado por local. | Procedimiento documentado y ejecutado al menos una vez durante el piloto. |

: Requerimientos organizacionales — operacionales
...
| **RNF-E-04** | **Aliflow no debe llegar a custodiar fondos de terceros en ningún flujo** (RN-14), evitando así la exposición regulatoria de esa figura. | Verificar que ningún flujo deja dinero en una cuenta controlada por Aliflow: el destino de cada recarga es la cuenta del proveedor, y el sistema no ofrece retiro, devolución en efectivo ni transferencia de saldo. |
...
: Requerimientos externos — de interoperabilidad
...
: Requerimientos externos — éticos y de equidad
